    ...
    useEffect(() => {
        ...
        const options = {
            strings: [
                ...
                "I am a full stack software engineer with a passion to create end to end solutions to solve problems at scale.",
            ],
            typeSpeed: 40,
            backSpeed: 30,
        };
    ...
    return (
        <div className="flex flex-col items-center flex-shrink-0 w-full box-border p-12 shadow-sm bg-gradient-to-r from-purple-100 via-blue-100 to-green-100 ">
            ...
            <div className="flex items-center my-2">
                <a
                    href="https://www.linkedin.com/in/chang-liu-87038691/"
                    className="mx-2"
                >
